...
class GaussianPredictor(nn.Module):
    ...
    def save_model(self, optimiser, step, lr_scheduler, ema=None):
    ...
    def load_model(self, weights_path, optimiser=None, lr_scheduler=None, device="cpu", ckpt_ids=0):
        ...
        if optimiser is not None:
            ...
            return optimiser, self.step, lr_scheduler
